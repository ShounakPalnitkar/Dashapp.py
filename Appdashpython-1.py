...
def update_data(n_intervals):
    ...
    return (
        px.bar(device_df, x="Device", y="Power Usage", title="Device Distribution"),
        px.bar(system_df, x="Value", y="Category", orientation='h', title="Power Management"),
        device_df.to_dict('records'),
        system_performance_figure,
        raspberry_pi_figure,
        px.line(time_df, x="Time", y="Detection Time", title="Temperature Levels"),
        px.line(time_df, x="Time", y="Detection Time", title="Object Detection Time"),
        kpi_cards
    )
