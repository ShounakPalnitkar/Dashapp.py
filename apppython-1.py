...
app.layout = html.Div(style={'backgroundColor': 'black', 'color': 'white', 'padding': '20px'}, children=[
    ...
    html.Div([html.Div([html.Div(dcc.Graph(id='power-management'), style={'border': '2px solid #cccccc', 'padding': '10px', 'borderRadius': '5px'})], style={'width': '70%', 'display': 'inline-block', 'verticalAlign': 'top'}),
    ...
    html.Div([html.Div([html.Div(dcc.Graph(id='system-performance'), style={'border': '2px solid #cccccc', 'padding': '10px', 'borderRadius': '5px'})], style={'width': '48%', 'display': 'inline-block'}), 
              html.Div([html.Div(dcc.Graph(id='raspberry-pi'), style={'border': '2px solid #cccccc', 'padding': '10px', 'borderRadius': '5px'})], style={'width': '48%', 'display': 'inline-block'})], style={'display': 'flex', 'justifyContent': 'space-around', 'marginBottom': '20px'}),

    # Fourth row: Temperature Level and Object Detection Time (Side by Side)
    html.Div([html.Div([html.Div(dcc.Graph(id='temperature-level'), style={'border': '2px solid #cccccc', 'padding': '10px', 'borderRadius': '5px'})], style={'width': '48%', 'display': 'inline-block'}), 
              html.Div([html.Div(dcc.Graph(id='object-detection-time'), style={'border': '2px solid #cccccc', 'padding': '10px', 'borderRadius': '5px'})], style={'width': '48%', 'display': 'inline-block'})], style={'display': 'flex', 'justifyContent': 'space-around', 'marginBottom': '20px'}),
...
def update_data(n_intervals):
    ...
    # Create your charts and tables using data from the DataFrames
